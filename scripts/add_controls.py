...
def query_size(Xdistance, Zdistance):
    """ Returns True or False based on the size of the objects bounding box. """
...
def combine_shapes(selection, name):
    """ Maya square shape is seperated by default, this code simply combines it into one shape like the circle shape. """
...
def create_controls(type, name):
    """ creates controls based on the user input type. """
